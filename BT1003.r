...
# nhiet do lon nhat theo nam   
tapply(Temperature$Temperature, Temperature$Year, max, na.rm = TRUE)
# nhiet do nho nhat theo nam
tapply(Temperature$Temperature, Temperature$Year, min, na.rm = TRUE)
# nhiet do trung binh theo nam
tapply(Temperature$Temperature, Temperature$Year, mean, na.rm = TRUE)
# trung vi nhiet do theo thang
tapply(Temperature$Temperature, Temperature$Year, median, na.rm = TRUE)
# tong nhiet do nho nhat theo nam
tapply(Temperature$Temperature, Temperature$Year, sum, na.rm = TRUE)
#  do man  lon nhat theo nam
tapply(Temperature$Salinity, Temperature$Year, max, na.rm = TRUE)
#  do man nho nhat theo nam
tapply(Temperature$Salinity, Temperature$Year, min, na.rm = TRUE)
# do man  trung binh theo nam 
tapply(Temperature$Salinity, Temperature$Year, mean, na.rm = TRUE)
# do man trung vi nhiet do theo nam
tapply(Temperature$Salinity, Temperature$Year, median, na.rm = TRUE)
# tong do man  theo nam
tapply(Temperature$Salinity, Temperature$Year, sum, na.rm = TRUE)
# tinh do man  trung binh ket hop 2 yeu to mua, nam
tapply(Temperature$Salinity, interaction(Temperature$Season , Temperature$Year), mean, na.rm = TRUE)
